...
public class ProductosDao {
    ...
    public boolean ModificarDatos(Config conf){
       boolean verifica;
       String sql = "UPDATE config SET ruc=?, nombre=?, telefono=?, direccion=?, mensaje=? WHERE ruc=? and id=?";
       String sql2 = "INSERT INTO `config`(`ruc`,`nombre`, `telefono`, `direccion`, `mensaje`) VALUES (?,?,?,?,?)";
       try {
           verifica = buscarConfig(conf.getId());
    ...
    public boolean buscarConfig(int id) throws SQLException{
         boolean retorno;
